...
const CodeImage = ({ src, alt }: { src: string; alt: string }) => (
  <div
    style={{
      width: "100%",
      height: "100%",
...
const items = [
  {
    ...
    header: <CodeImage src="/ray-frontend.png" alt="Next.js page.tsx code snippet" />,
  ...
  },
  {
    ...
    header: <CodeImage src="/ray-backend.png" alt="Spring Boot ApiController.java code snippet" />,
  ...
  },
  {
    ...
    header: <CodeImage src="/ray-uiux.png" alt="CSS design-tokens.css code snippet" />,
  ...
  },
  {
    ...
    header: <CodeImage src="/ray-mobile.png" alt="SwiftUI ContentView.swift code snippet" />,
